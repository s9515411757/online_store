# Интернет-магазин
### Отображаем полноценный функционирующий сервис

```shell
Цель создать сервис, через который будет доступно и без лишних шагов оформлять заказы
Сам сервис будет тестовый
```
...
![alt text]([https://raw.githubusercontent.com/WISEPLAT/imgs_for_repos/master/get_from_vcs.jpg ](https://github.com/s9515411757/online_store.git)

Вот ссылка на этот проект:
```shell
https://github.com/s9515411757/online_store.git
```
